...
from src.abstraction.isomorphism.suit_canonicalization import CanonicalCard
...
class BoardClusterer:
    ...
    def fit(
        ...
        # Build cluster info
        from src.abstraction.isomorphism.suit_canonicalization import get_canonical_board_id
