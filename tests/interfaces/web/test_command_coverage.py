...
DESTRUCTIVE: dict[str, str] = {
    ...
    "backfill-record": "a one-way mirror of the record into Postgres, run a handful of "
    "times during a migration and never again; a permanent button for a temporary job",
